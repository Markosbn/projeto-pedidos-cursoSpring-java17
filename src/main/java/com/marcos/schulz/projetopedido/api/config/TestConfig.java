...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //relacionar as categorias nos produtos "ManyToMany associação"
        //chamar a categoria dos produtos e adicionar a catetogoria
        ...
        //no fim é so salvar novamente o produto
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p3, p4, p5));
